...
- The dashboard is split into five hash-routed tabs (`#users`, `#projects`, `#hub`, `#leads`, `#marketing`) so the page never grows into one long scroll; `script.js` is an ES module.
