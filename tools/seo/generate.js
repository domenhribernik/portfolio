...
//?     <!-- seo:projects:start/end --> markers inside <projects-paper>.
...
import {
    ...
    projectsFallbackHtml, postsFallbackHtml, blogPostPage, validateSlug,
} from './logic.js';
...
outputs.set('index.html', replaceBetweenMarkers(
    ...
    '<!-- seo:projects:end -->',
    projectsFallbackHtml(projects, FLAGSHIP),
));
