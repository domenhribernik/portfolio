...
//?   - views/tells/index.html: the static plate list between the
//?     <!-- seo:tells:start/end --> markers inside #grid.
...
//? The guide's 48 plates live in a fetched JSON catalog, so the crawlable
//? copy has to be prerendered or the page indexes as an empty shell.
outputs.set('views/tells/index.html', replaceBetweenMarkers(
    read('views/tells/index.html'),
    '<!-- seo:tells:start (generated by tools/seo/generate.js, do not hand-edit) -->',
    '<!-- seo:tells:end -->',
    tellsFallbackHtml(JSON.parse(read('views/tells/data/catalog.json'))),
));
