-- Everbloom founding waitlist (views/bloom).
-- Public, unauthenticated writes via app/proxys/bloom.php: each row is one
...
CREATE TABLE IF NOT EXISTS bloom_waitlist (
    ...
    UNIQUE KEY uniq_bloom_email (email),
    INDEX idx_bloom_created (created_at)
