export const projects = {
  ...
  OCRAlgorithm: {
    ...
    description: {
      eng: "Research project and implementation of an OCR-based system designed to assist individuals with physical disabilities in accessing parking spaces. Awarded a national silver prize for innovation.",
      slo: "Raziskovalna naloga in implementacija OCR-sistema za pomoč gibalno oviranim osebam pri dostopu do parkirnih mest. Nagrajena s srebrnim priznanjem za inovacijo na državnem nivoju."
    },
  ...
  FruitAlgorithm: {
    ...
    description: {
      eng: "Course project tackling a coding challenge on strategic fruit placement to minimize apple picks. Includes both brute-force and dynamic programming solutions and their comparison.",
      slo: "Projektna naloga, ki rešuje izziv optimizacije postavitve sadja za čim manj pobranih jabolk. Vključuje rešitvi z metodo brute-force in dinamičnim programiranjem in njuno primerjavo."
    },
